...
<?php include ('joueurs.php'); ?>
  <div class="container">
    <div class="row justify-content-around">
      ...
      <div class="button"><a href="Support.php?sup=-1">Reset</a></div>
    </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($players as $player){
                    if ($player['poste']=='Support'){
                        ?>
                        <tr>
                            <td><?php echo $player['nom'] ?></td>
                            <td><?php echo $player['poste'] ?></td>
                            <td><div class="button"><a href="Support.php?sup=<?php echo $player['idJoueur']; ?>">Ajouter</a></div></td>
                        </tr>
                        <?php
                    }
                }
