  ...
  <div class="container">
    <div class="row justify-content-around">
      <div class=".col-4">
        ...
        <div class="button"><a href="Toplaner.php?top=-1">Reset</a></div>
      </div>


      <div class=".col-10">
        <h1> Ajouter un Toplaneur : </h1>
          <table class="table table-bordered">
              <thead>
              <tr>
                  <th>~Nom~</th>
              ...
              <tbody>
                  <?php foreach ($players as $player){
                      if ($player['poste']=='Toplaner'){
                          ?>
                          <tr>
                              <td><?php echo $player['nom'] ?></td>
                              <td><?php echo $player['poste'] ?></td>
                              <td><div class="button"><a href="Toplaner.php?top=<?php echo $player['idJoueur']; ?>">Ajouter</a></div></td>
                          </tr>
                          <?php
                      }
                  }
