...
<?php session_start(); ?>
  ...
  <?php include ('joueurs.php'); ?>
    <div class="container">
      ...
      <div class="button"><a href="Jungler.php?jun=-1">Reset</a></div>
    </div>


    <div class=".col-10">
      <h1> Ajouter un Jungler : </h1>
        <table class="table table-bordered">
            <thead>
            <tr>
                <th>~Nom~</th>
            ...
            <tbody>
                <?php foreach ($players as $player){
                    if ($player['poste']=='Jungler'){
                        ?>
                        <tr>
                            <td><?php echo $player['nom'] ?></td>
                            <td><?php echo $player['poste'] ?></td>
                            <td><div class="button"><a href="Jungler.php?jun=<?php echo $player['idJoueur']; ?>">Ajouter</a></div></td>
                        </tr>
                        <?php
                    }
                }
