    ...
    <div class="row justify-content-around">
      <div class=".col-4">
        ...
        <table class="table table-bordered">
          ...
          <div class="button"><a href="ADC.php?adc=-1">Reset</a></div>
      </div>


      <div class=".col-10">
      <h1> Ajouter un ADC : </h1>
          <table class="table table-bordered">
              <thead>
              <tr>
                  <th>~Nom~</th>
                  ...
                  <?php foreach ($players as $player){
                      if ($player['poste']=='ADC'){
                          ...
                          <tr>
                              <td><?php echo $player['nom'] ?></td>
                              <td><?php echo $player['poste'] ?></td>
                              <td><div class="button"><a href="ADC.php?adc=<?php echo $player['idJoueur']; ?>">Ajouter</a></div>
                              </td>
                          </tr>
                          <?php
                      }
